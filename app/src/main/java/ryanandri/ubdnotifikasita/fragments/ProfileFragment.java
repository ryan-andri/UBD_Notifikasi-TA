...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        TextView namaMahasiswa = view.findViewById(R.id.mhsNAMA);
        namaMahasiswa.setText(sesiNama);

        TextView nimMahasiswa = view.findViewById(R.id.mhsNIM);
        nimMahasiswa.setText(sesiNim);

        TextView sksMahasiswa = view.findViewById(R.id.mhsSKS);
        sksMahasiswa.setText(String.valueOf(sesiSks));

        TextView pbb1 = view.findViewById(R.id.pembimbing1);
        pbb1.setText(sesiPbb1);
        TextView pbb2 = view.findViewById(R.id.pembimbing2);
